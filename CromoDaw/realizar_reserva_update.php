<?php session_start();
	...
	$conexion = mysqli_connect('mysql.hostinger.es', 'u841122470_root', 'qweQWE123', 'u841122470_cromo');
...
if (isset($_SESSION['usu_name'])) {
	...
	$conexion = new PDO('mysql:host=mysql.hostinger.es;dbname=u841122470_cromo','u841122470_root','qweQWE123');
