			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li><a class="active" href="portfolio.html">Devolver</a></li>

						<li><a href="contact.html">Incidencias</a></li>
					</ul>
				</nav>
			</div>
		</div>
...
<?php
	$conexion = mysqli_connect('localhost', 'root', '', 'bd_cromo');
		...
		if(mysqli_num_rows($reservas)!=0){
			echo " <h3> Número de recursos: " . mysqli_num_rows($reservas) . "<br/><br/></h3>";
